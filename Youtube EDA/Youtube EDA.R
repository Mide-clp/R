...
ggplot(data = YT_category)+
  ...
  labs( title = "Category vs views",
        subtitle = "most watched categories on youtube", caption = "mide")
...
ggplot(data = YT_category)+
  ...
  labs( title = "Category vs likes",
        subtitle = "most liked categories on youtube", caption = "mide")

### The most disliked categories----------------------------------------------------------------
...
ggplot(data = YT_category)+
  ...
  labs( title = "Category vs dislikes",
        subtitle = "most disliked categories on youtube", caption = "mide")
  

### categories with the most comment----------------------------------------------------------------
...
ggplot(data = YT_category)+
  ...
  labs( title = "Category vs comments",
        subtitle = "categories with the most comments on youtube", caption = "mide")



### ratio of likes to dislikes by categories----------------------------------------------------------------
...
ggplot(data = YT_category)+
  ...
  labs( title = "Category vs like ratio",
        subtitle = "categories with the highest ratio of likes to dislikes on youtube", caption = "mide")
...
YT_videos %>% 
  ...
  theme(panel.background = element_rect(fill = "#244C6C"), 
        ...
        plot.title = element_text(size = 25, face = "bold"), 
        plot.subtitle = element_text(size = 15), plot.caption = element_text(size = 15))+
  labs( title = "Most viewed  channels",
        subtitle = "channels with the highest number of views on youtube", caption = "mide")  
...
### most liked channel----------------------------------------------------------------
 ...
 YT_videos %>% 
  ...
  ggplot()+
    ...
    theme(panel.background = element_rect(fill = "#244C6C"), 
          ...
          plot.title = element_text(size = 25, face = "bold"), 
          plot.subtitle = element_text(size = 15), plot.caption = element_text(size = 15))+
    labs( title = "Most liked channels",
          subtitle = "channels with the highest number of likes on youtube", caption = "mide")  
 ...
 YT_videos %>% 
   ...
   theme(panel.background = element_rect(fill = "#244C6C"), 
         ...
         plot.title = element_text(size = 25, face = "bold"), 
         plot.subtitle = element_text(size = 15), plot.caption = element_text(size = 15))+
   labs( title = "Most disliked channels",
         subtitle = "channels with the highest number of dislikes on youtube", caption = "mide")  
 ...
 YT_videos %>% 
   ...
   theme(panel.background = element_rect(fill = "#244C6C"), 
         ...
         plot.title = element_text(size = 25, face = "bold"), 
         plot.subtitle = element_text(size = 15), plot.caption = element_text(size = 15))+
   labs( title = "Most commented on channels",
         subtitle = "channels with the highest number of comments on youtube", caption = "mide")  
